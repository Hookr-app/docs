...
|---------|-------------|---------------|----|
| **Private Mode** | Event data stays only on your device, never on Hookr servers | You have sensitive information (financial data, credentials, personal details) | [Private Mode](../features/private-mode.mdx) |
| **Time Sensitive** | iPhone notifications break through Do Not Disturb mode | You need urgent alerts that can't wait | [Time Sensitive Notifications](../features/time-sensitive.mdx) |
| **Forwarding** | Automatically send event data to external URLs (up to 3) | You want to integrate with Zapier, custom APIs, or other services | [Forwarding (Proxying)](../features/forwarding-proxying.mdx) |
...
See [Message Templates with Handlebars](../features/handlebars.mdx) for detailed instructions on how to insert event data into your messages.
